...
export default function Sidebar({ userRole = 'user' }: SidebarProps) {
  ...
  const adminNavigation: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          name: 'Statistiques Passerelles',
          href: '/network/gateways/stats',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
        ...
        {
          name: 'Accès SSH Passerelles',
          href: '/network/gateways/ssh',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
          name: 'Déploiement FUOTA',
          href: '/network/fuota/deploy',
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const allNavigation = [...navigation, ...(userRole === 'admin' || userRole === 'super-admin' ? adminNavigation : [])];
    ...
    <div className="h-full bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">LoRaWAN</h1>
            <p className="text-xs text-gray-500">Plateforme IoT</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto p-4 space-y-1">
        {allNavigation.map((item) => renderNavItem(item))}
      </nav>
